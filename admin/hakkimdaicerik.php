            ...
            <div class="col-12">
                ...
                if ($_POST) {
                    ...
                    if (move_uploaded_file($_FILES['foto']['tmp_name'], $yuklenecekfoto)) {
                        $sorgu_hakkimdaicerik = $db->prepare('insert into hakkimdaicerik(foto,altbaslik,icerik,altbaslik2) values(?,?,?,?)');
                        $sorgu_hakkimdaicerik->execute(array($yuklenecekfoto, $altbaslik, $icerik,$_POST['altbaslik2']));
